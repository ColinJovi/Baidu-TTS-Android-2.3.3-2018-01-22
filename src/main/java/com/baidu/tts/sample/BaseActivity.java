...
public class BaseActivity extends AppCompatActivity implements MainHandlerConstant {
    ...
    protected Button[] buttons;//按钮总控
    protected Button mHelp;
    protected Button mOpenfile;
    protected EditText mInput;
    protected TextView mShowText;
    protected TextView mFilepathtxt;
    protected Handler mainHandler;
    StringBuffer thisBuffer;
    int seg;//每页多少字
    int pages;//总页数
    int totalNum;//总字数
    int tempPageNum;//当前页多少字
    protected Button mFirstPage;
    protected Button mPrePage;
    protected Button mNextPage;
    protected Button mLastPage;
    ...
    private void initialView() {
        ...
        mOpenfile=(Button)this.findViewById(R.id.openfile);
        ...
        mFilepathtxt=(TextView)this.findViewById(R.id.filepathtxt);
        thisBuffer=new StringBuffer();
        seg=500;
        tempPageNum=0;
        pages=0;
        totalNum=0;

        mFirstPage=(Button) this.findViewById(R.id.firstpage);
        mPrePage=(Button) this.findViewById(R.id.prepage);
        mNextPage=(Button) this.findViewById(R.id.nextpage);
        mLastPage=(Button) this.findViewById(R.id.lastpage);
        buttons = new Button[]{
                mSpeak, mPause, mResume, mStop, mSynthesize, mBatchSpeak, mLoadModel,mOpenfile
                ,mFirstPage,mPrePage,mNextPage,mLastPage
        };
    }
